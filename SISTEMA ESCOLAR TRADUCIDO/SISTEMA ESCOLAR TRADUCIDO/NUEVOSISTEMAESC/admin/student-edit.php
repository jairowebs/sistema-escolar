...
<body>
    <?php 
     ...
     <div class="container mt-5">
        ...
        <h3>Editar información estudiante</h3><hr>
        ...
        <div class="mb-3">
          <label class="form-label">Apellido Acudiente</label>
          <input type="text" 
                 class="form-control"
        ...
        <div class="mb-3">
          <label class="form-label">Numero contacto acudiente</label>
          <input type="text" 
                 class="form-control"
