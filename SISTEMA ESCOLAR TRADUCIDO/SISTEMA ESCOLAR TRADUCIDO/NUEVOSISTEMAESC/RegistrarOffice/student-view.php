...
<head>
	...
	<title>Registrar Office - Vista estudiante</title>
     ...
     <div class="container mt-5">
         <div class="card" style="width: 22rem;">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Nombre de usuario: <?=$student['username']?></li>
            ...
            <li class="list-group-item">Telefono de contacto Acudiente: <?=$student['parent_phone_number']?></li>
          </ul>
          <div class="card-body">
