...
<head>
	...
	<title>Profesor - Estudiantes por Grado</title>
        ...
        <form method="post"
            ...
            <div class="mb-3">
                <ul class="list-group">
                  ...
                  <li class="list-group-item"><b>Nombre: </b> <?php echo $student['fname'] ?></li>
                  <li class="list-group-item"><b>Aepllido: </b> <?php echo $student['lname'] ?></li>
                  <li class="list-group-item"><b>Grado: </b> 
                    <?php  $g = getGradeById($student['grade'], $conn); 
                        echo $g['grade_code'].'-'.$g['grade'];
                    ?>
                  </li>
                  <li class="list-group-item"><b>Sección: </b> 
                    <?php  $s = getSectioById($student['section'], $conn); 
                        echo $s['section'];
                    ?>
                  </li>
                  <li class="list-group-item text-center"><b>Anio: </b> <?php echo $setting['current_year']; ?> &nbsp;&nbsp;&nbsp;<b>Periodo</b> <?php echo $setting['current_semester']; ?></li>
                </ul>
            </div>
            <h5 class="text-center">Agregar Grado</h5>
         ...
         <label class="form-label">Materia / Curso</label>
